...
<body class="font-['Cairo'] bg-[var(--dark-background)] text-[var(--text-light)] leading-relaxed">
    <nav class="bg-gradient-to-r from-[var(--dark-background)] to-[var(--primary-color)] shadow-md py-2 px-4">
        <div class="container mx-auto flex items-center justify-between md:justify-normal">
            <!-- اسم التطبيق -->
