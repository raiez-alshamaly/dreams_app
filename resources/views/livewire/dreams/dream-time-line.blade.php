...
<div>
    ...
    {{-- <div class="group relative flex gap-x-5">
      ...
      <div class="grow pb-8 group-last:pb-0">
        ...
        <div class="mt-3">
          <!-- Card -->
          <a class="block border border-gray-200 rounded-lg hover:shadow-2xs focus:outline-hidden" href="#">
