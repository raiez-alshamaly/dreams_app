        ...
        <div class="ticker-track flex whitespace-nowrap h-full items-center">
            @forelse ($fulfilledDreams as $dream)
                <div
                    ...
                    <span class="ticker-name font-semibold text-[var(--color-light-200)] me-2">{{ $dream->full_name }}</span>
            ...
            @empty
                <div
                    ...
                    <span class="ticker-name font-semibold text-[var(--color-light-200)]">كن أول من يحقق حلمه!</span>
                </div>
            @endforelse
        </div>
