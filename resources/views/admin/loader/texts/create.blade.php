<x-layouts.admin>
    ...
    <form action="{{ route('admin.loader.text.store') }}" method="POST"
        ...
        <x-widgets.forms.input label="النص" id="text" />
        ...
        <div class="flex">
            ...
            <label for="is_active" class="text-sm text-gray-200 ms-3">مفعل </label>
        </div>
